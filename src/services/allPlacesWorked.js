...

{
    ...
    technical: 'Jenkins, serverless, Next.JS, React, Mobx, GIT, AWS s3 and ec2',
    image: 'bom-cover.jpg',
    colour:'pink'
},

    {
    ...
    },
     {
        ...
        description:' During my time at Australian Unity I transformed the entire structure of the frontend architecture and was updating the sitecore instances to use JSS for decoupling of the frontend. I would work across 4 teams to keep consistency. I aligned with all the frontends to get a uniformed structure so that the code merging will be easy to maintain across all environments.',
    ...
    },
    {
        ...
        name:'MYER',
        position: 'Lead Frontend Developer.',
        description: 'I am currently working with a React and Redux with a mobile first development approach with a focus on a rich data driven application.'+
       ...
       },
       {
        ...
        technical:'CHARLES, SVN, SASS, ANGULAR.JS, COMPASS, HTML5, CSS3, JSON, AJAX, BOOTSTRAP,CREATIVE CLOUD, EDGE INSPECTOR, IIS, VISUAL STUDIO EXPRESS .NET, Drupa',
        image: 'fcv-cover.jpg',
        colour:'#ff8100'
       },
       {
        ...
        `,
        technical:'  BIT BUCKET, GIT HUB, SASS, LESS, PHP, HTML5, CSS3, JSON, AJAX, BOOTSTRAP, BACKBONE.JS, MAGENTO, DJANGO ',
